...
Area_h1=Area_h1(abs(Area_h1-mean(Area_h1))<3*std(Area_h1));
Area_z1=Area_z1(abs(Area_z1-mean(Area_z1))<3*std(Area_z1));
Area_h2=Area_h2(abs(Area_h2-mean(Area_h2))<3*std(Area_h2));
Area_z2=Area_z2(abs(Area_z2-mean(Area_z2))<3*std(Area_z2));
Area_hall=Area_hall(abs(Area_hall-mean(Area_hall))<3*std(Area_hall));
Area_zall=Area_zall(abs(Area_zall-mean(Area_zall))<3*std(Area_zall));
...
% ylabel('area')
% title('subM 浅化解析')
% [p3,h3]=ttest2(Area_h1,Area_h2);
% [fp3,fh]=vartest2(Area_h1,Area_h2);
% 
% subplot(2,3,4)
% plot(1,Area_z1,'o')
% hold on
...
% ylabel('area')
% title('subM 浅化解析')
% [p4,h4]=ttest2(Area_z1,Area_z2);
% [fp4,fh4]=vartest2(Area_z1,Area_z2);
