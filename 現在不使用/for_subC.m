...
for a=1:a1
    if a>ahalf
        subplot(2,3,4)
        none_inverse=none_bottomup(a,6:36);
        if isnan(none_inverse(31))==0
        ...
        title('subC ジャンプなし条件 後半','FontSize',14)
    else
        subplot(2,3,1)
        none_inverse=none_bottomup(a,6:36);
        if isnan(none_inverse(31))==0
        ...
        %         line([0 50],[ERDGoal ERDGoal],'color','b','LineWidth',1,'Linestyle','-');
        line([0 5000],[0 0],'color','k','LineWidth',2,'Linestyle','-');
        title('subC ジャンプなし条件 前半','FontSize',14)
    end
end
...
for b=1:b1
    if b>bhalf
        subplot(2,3,5)
        half_inverse=half_bottomup(b,6:36);
        if isnan(half_inverse(31))==0
        ...
        %         line([0 50],[ERDGoal ERDGoal],'color','b','LineWidth',1,'Linestyle','-');
        line([0 5000],[0 0],'color','k','LineWidth',2,'Linestyle','-');
        title('subC 小ジャンプ条件 後半','FontSize',14)
    else
        subplot(2,3,2)
        half_inverse=half_bottomup(b,6:36);
        if isnan(half_inverse(31))==0
        ...
        %         line([0 50],[ERDGoal ERDGoal],'color','b','LineWidth',1,'Linestyle','-');
        line([0 5000],[0 0],'color','k','LineWidth',2,'Linestyle','-');
        title('subC 小ジャンプ条件 前半','FontSize',14)
    end
end
...
for c=1:c1
    if c>chalf
        subplot(2,3,6)
        zero_inverse=zero_bottomup(c,6:36);
        if isnan(zero_inverse(31))==0
        ...
        %         line([0 50],[ERDGoal ERDGoal],'color','b','LineWidth',1,'Linestyle','-');
        line([0 5000],[0 0],'color','k','LineWidth',2,'Linestyle','-');
        title('subC 大ジャンプ条件 後半','FontSize',14)
    else
        subplot(2,3,3)
        zero_inverse=zero_bottomup(c,6:36);
        if isnan(zero_inverse(31))==0
        ...
        %         line([0 50],[ERDGoal ERDGoal],'color','b','LineWidth',1,'Linestyle','-');
        line([0 5000],[0 0],'color','k','LineWidth',2,'Linestyle','-');
        title('subC 大ジャンプ条件 前半','FontSize',14)
    end
end

save('subC_area3_3000','Area_n1','Area_n2','Area_h1','Area_h2','Area_z1','Area_z2')